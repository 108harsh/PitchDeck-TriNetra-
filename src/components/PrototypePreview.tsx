        ...
        <section id="demo" className="py-32 px-4 bg-white/5 relative overflow-hidden border-t border-white/10">
            <div className="max-w-4xl mx-auto text-center relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                    <Button size="lg" className="h-16 rounded-full px-12 text-lg font-bold bg-white text-black hover:bg-emerald-400 hover:text-black transition-colors w-full sm:w-auto">
                        Launch Dashboard
                        <ExternalLink className="ml-2 w-5 h-5" />
                    </Button>
                    <Button variant="outline" size="lg" className="h-16 rounded-full px-12 text-lg bg-transparent border-white/20 text-white hover:bg-white/10 w-full sm:w-auto">
                        View Source
                ...
                <div className="mt-32 pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center text-xs font-mono text-white/30 uppercase tracking-widest gap-4">
                    ...
                    <span>St. Vincent Pallotti // GH Raisoni</span>
